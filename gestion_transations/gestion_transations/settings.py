"""
Django settings for gestion_transations project.
...
SECRET_KEY = 'django-insecure-92#2l)(z-xz60-g2a15u_l83nm5cwnz-7#j^s$no#6z@5k!+q6'
...
ROOT_URLCONF = 'gestion_transations.urls'
...
WSGI_APPLICATION = 'gestion_transations.wsgi.application'
